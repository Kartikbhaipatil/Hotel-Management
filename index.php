  ...
  <body>
    <header class="header">
      <nav>
        <div class="nav__bar">
          <div class="logo">
            <a href="#"><img src="hotel-images/logo.png" alt="logo" /></a>
          </div>
    ...
    <section class="section__container about__container" id="about">
      <div class="about__image">
        <img src="hotel-images/about.jpg" alt="about" />
      </div>
    ...
    <section class="section__container room__container">
      <p class="section__subheader" style="margin-left: 450px";>OUR LIVING ROOM</p>
      <h2 class="section__header">The Most Memorable Rest Time Starts Here.</h2>
      <div class="room__grid">
        <div class="room__card">
          <div class="room__card__image">
            <img src="hotel-images/room-1.jpg" alt="room" />
        ...
        <div class="room__card">
          <div class="room__card__image">
            <img src="hotel-images/room-2.jpg" alt="room" />
            <div class="room__card__icons">
              <span><i class="ri-heart-fill"></i></span>
              <span><i class="ri-paint-fill"></i></span>
              <span><i class="ri-shield-star-line"></i></span>
        ...
        <div class="room__card">
          <div class="room__card__image">
            <img src="hotel-images/room-3.jpg" alt="room" />
            <div class="room__card__icons">
              <span><i class="ri-heart-fill"></i></span>
              <span><i class="ri-paint-fill"></i></span>
              <span><i class="ri-shield-star-line"></i></span>
    ...
    <footer class="footer" id="contact">
      <div class="section__container footer__container">
        <div class="footer__col">
          <div class="logo">
            <a href="#home"><img src="hotel-images/logo.png" alt="logo" /></a>
          </div>
          <p class="section__description">
        ...
        <div class="footer__col">
          ...
          <div class="footer__socials">
            <a href="#"><img src="hotel-images/facebook.png" alt="facebook" /></a>
            <a href="#"><img src="hotel-images/instagram.png" alt="instagram" /></a>
            <a href="#"><img src="hotel-images/youtube.png" alt="youtube" /></a>
            <a href="#"><img src="hotel-images/twitter.png" alt="twitter" /></a>
          </div>
        </div>
      </div>
      <div class="footer__bar">
        Copyright © 2025 Web Design --Kartikbhai. All rights reserved.
      </div>
    </footer>
